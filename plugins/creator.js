...
if (command == 'owner') {
 let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:WhatsApp;Saya Owner Anya;Bot;;Md\nFN:Saya Owner Anya Bot WhatsApp, Md\nNICKNAME:👑 Owner Anya Bot\nORG: KoncitOfc\nTITLE:soft\nitem1.TEL;waid=621364444859:+62 813-6444-4659\nitem1.X-ABLabel:📞 Nomor Owner\nitem2.URL:https://koncit.github.io\nitem2.X-ABLabel:💬 More\nitem3.EMAIL;type=INTERNET:tnnckl1553@gmail.com\nitem3.X-ABLabel:💌 Mail Owner Anya Bot\nitem4.ADR:;;🇮🇩 Indonesia;;;;\nitem4.X-ABADR:💬 More\nitem4.X-ABLabel:📍 Lokasi Saya\nBDAY;value=date:🔖 00 January 0000\nEND:VCARD`
...
if (command == 'pengembang') {
  let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;${author};;;\nFN:${author}\nORG:${author}\nTITLE:\nitem1.TEL;waid=6281364444859:+62 813-6444-4659\nitem1.X-ABLabel:${author}\nX-WA-BIZ-DESCRIPTION:${htjava} Nih pengembang ku kack yg mengaktifkan aq.\nX-WA-BIZ-NAME:${author}\nEND:VCARD`
await conn.sendMessage(m.chat, { contacts: { displayName: wm, contacts: [{ vcard }] }}, { quoted: fakes })
}
if (command == 'creator') {
  try {
  const sentMsg = await conn.sendContactArray(m.chat, [
    [`${nomorown}`, `${await conn.getName(nomorown+'@s.whatsapp.net')}`, `👑 Developer Bot `, `🚫 Don't call me 🥺`, `tnnckl1553@gmail.com`, `🇮🇩 Indonesia`, `🚀 https://koncit.github.io/`, `👤 Gada pawang nih senggol dong 😔`],
    [`${conn.user.jid.split('@')[0]}`, `${await conn.getName(conn.user.jid)}`, `🔥 Bot WhatsApp 🐣`, `📵 Don't spam/call me 😢`, `Nothing`, `🇮🇩 Indonesia`, `🚀 https://koncit.github.io/`, `🤖 Hanya bot biasa yang kadang suka eror ☺`]
  ], fakes)
